...
export const SideMenu = () => {
  ...
  const isAdminLogged = useMemo(() => isLoggedIn && user?.role === "admin", [isLoggedIn, user]);
    ...
    >
      <Box sx={{ width: 250, paddingTop: 5 }}>
        <List>
          ...
          {/* <ListItem button sx={{ display: isLoggedIn ? "flex" : "none" }}  onClick={() => navigateTo("/profile")}>
            <ListItemIcon>
              <AccountCircleOutlined />
            </ListItemIcon>
          ...
          <ListItem button sx={{ display: isLoggedIn ? "flex" : "none" }} onClick={() => navigateTo("/orders/history")}>
            <ListItemIcon>
              <ConfirmationNumberOutlined />
            </ListItemIcon>
          ...
          <ListItem button onClick={logout} sx={{ display: isLoggedIn ? "flex" : "none" }}>
            <ListItemIcon>
              <LoginOutlined />
            </ListItemIcon>
